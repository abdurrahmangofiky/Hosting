...
// AMBIL DATA
$data  = mysqli_query($koneksi, "SELECT * FROM tenant_aktif ORDER BY id DESC");
...
<div class="sidebar">
    ...
    <nav>
        ...
        <a href="../tenant_aktif/index.php" class="active">Tenant Aktif</a>
...
<div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:30px;">
    <div>
        <h1>Tenant Aktif</h1>
        <p>Daftar Tenant yang sedang menyewa di Plaza Asia Tasikmalaya</p>
    </div>
...
<tr>
    ...
    <th>Aksi</th>
        ...
        <tbody>
            ...
            <?php else: ?>
                <tr>
                    <td colspan="4" style="text-align:center; padding:20px;">Belum ada tenant aktif</td>
                </tr>
            <?php endif; ?>
        </tbody>
        <!-- AKHIR LOOP DATA -->
